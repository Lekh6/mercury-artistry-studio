...
function ProjectsPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <ReturnBar />
      <main className="mx-auto max-w-7xl px-6 pb-32 pt-20 md:px-12 md:pt-28">
        <header className="mb-24 grid gap-8 border-b border-border pb-12 md:grid-cols-[1fr_auto] md:items-end">
        ...
        <div className="space-y-28 md:space-y-40">
          {portfolioProjects.map((project, index) => (
            <article key={project.index} className={`project-row ${index % 2 ? "md:ml-auto" : ""}`}>
